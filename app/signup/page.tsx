      ...
      <div className="relative hidden w-1/2 lg:block">
        ...
        <div className="relative z-20 flex h-full flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-bold">Start Selling Smarter</h1>
            <p className="text-lg text-white/80">
              Create an account and start managing your e-commerce business across multiple platforms.
            </p>
          ...
          <div className="space-y-4">
            <p className="text-sm text-white/60">
              &quot;Success in e-commerce is about being everywhere your customers are.&quot;
            </p>
      ...
      <div className="relative flex w-full lg:w-1/2 items-center justify-center p-8 sm:p-12 lg:p-16 bg-gray-50/80">
        ...
        <div className="relative w-full max-w-md space-y-8">
          <div className="lg:hidden space-y-4 text-center mb-8">
            ...
            <h1 className="text-2xl font-bold">Start Selling Smarter</h1>
            <p className="text-muted-foreground">
              Create an account to manage your e-commerce business.
            </p>
          </div>
